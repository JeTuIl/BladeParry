...
public class LifebarManager : MonoBehaviour
{
    ...
    public float CurrentLifeValue { get => currentLifeValue; set { currentLifeValue = value; RefreshNumeric(); SyncBarWidthsToValues(syncRedBar: false); } }
    ...
    /// <summary>Syncs _currentFillWidth and optionally _currentRedBarWidth to the current/max ratio. When syncRedBar is false (e.g. on current life change), only the fill bar is updated so the red bar can trail and lerp.</summary>
    private void SyncBarWidthsToValues(bool syncRedBar = true)
    {
