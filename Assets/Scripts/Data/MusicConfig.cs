...
{
    /// <summary>Music clip to play during the fight. When set, applied at fight start via MusciSwitchManager.</summary>
    ...
    /// <param name="value">The audio clip to play during the fight.</param>
    ...
    /// <param name="value">Pitch/speed value (e.g. 1f for normal).</param>
